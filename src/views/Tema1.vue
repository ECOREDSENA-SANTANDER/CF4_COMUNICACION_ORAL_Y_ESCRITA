  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.justify-content-center.align-items-center.mb-5(data-aos='fade-right')
        .col-sm-12.col-lg-4
          ul.lista-ul--color.mb-0.br-2
              li.d-flex.justify-content-center.align-items-start
                i.fas.fa-play.bg-color-4.mg-2
                p.tit-1 Tipos de textos

        .col-sm-12.col-lg-5.px-4
          p.mb-0 Para el caso que nos ocupa en este recurso de comunicación oral y escrita, se hará relevancia en los textos científicos o técnicos y en textos narrativos.

      .row.justify-content-center.mb-5(data-aos='fade-right')
        .col-sm-12.col-lg-10
          img.mb-2(src='@/assets/curso/temas/t1/5.svg', alt='')
      ...
      .row.justify-content-center.mb-5
        .col-sm-12.col-lg-10
          ...
          img.wc-75.m-auto(src='@/assets/curso/temas/t1/9.svg', alt='')
      ...
      .row.justify-content-center.mb-5.align-items-center(data-aos='fade-right')
        ...
        .col-sm-12.col-lg-6
            ...
            ul.lista-ul--color.mb-0
              ...
              li.d-flex
                i.fas.fa-leaf.icon-list
                p.mb-0 Organiza el material consultado y citado por estudiantes, profesores e investigadores.
      ...
      .row.justify-content-center.mb-5(data-aos='fade-right')
        ...
        .col-sm-12.col-lg-9
          ...
          p.fw-bold.mb-5 Navas Talero, M (2016) señala:
      ...
      .row.justify-content-center.mb-0.align-items-start(data-aos='fade-right')
        ...
        .col-sm-12.col-lg-9
          .titulo-only-text.mb-5
            h3.mb-0.titulo-only-text-info.px-0.py-2 En cuanto a escribir
          .bloque-texto-f.color-acento-contenido.pt-4.pc-2.mb-0
            .bloque-texto-f__comillas
              i.fas.fa-quote-left
              i.fas.fa-quote-right
